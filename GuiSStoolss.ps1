...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Border x:Name="MainBorder" CornerRadius="24" BorderBrush="#1A2E24" BorderThickness="1" Background="#0A120F">
        <Border.Effect>
            <DropShadowEffect BlurRadius="45" ShadowDepth="0" Opacity="0.65"/>
        </Border.Effect>
        ...
        <Grid>
            ...
            <Grid Margin="30">
                ...
                <Grid>
                    <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                        <Border Width="52" Height="52" CornerRadius="14" Background="#0F1A16" BorderBrush="#4ADE80" BorderThickness="3" x:Name="LogoBorder">
                            <Border.Effect>
                                <DropShadowEffect x:Name="LogoGlow" Color="#4ADE80" BlurRadius="30" ShadowDepth="0" Opacity="0.9"/>
                            </Border.Effect>
                ...
                <!-- Control Panel -->
                <Border Grid.Row="2" Background="#0F1A16" CornerRadius="18" BorderBrush="#2A4738" BorderThickness="1" Padding="25" Margin="0,20,0,0">
                    <Grid>
                        <Grid.ColumnDefinitions>
                            <ColumnDefinition Width="*"/>
                            <ColumnDefinition Width="*"/>
...
try {
    ...
    $RemoveButton.Add_Click({
        if (Test-Path $destPath) {
            ...
            $ActivityBox.AppendText("`n[Remove] Tools removed.`n")
        } else {
